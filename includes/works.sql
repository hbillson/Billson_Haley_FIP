...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Dec 06, 2020 at 11:54 AM
...
CREATE TABLE IF NOT EXISTS `works` (
  ...
  `mediatype` varchar(20) COLLATE utf16_swedish_ci NOT NULL,
  `smaller_img` varchar(80) COLLATE utf16_swedish_ci NOT NULL,
  `source` varchar(80) COLLATE utf16_swedish_ci NOT NULL,
